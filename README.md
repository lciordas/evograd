...
This is a research library for exploring how **gradient-based learning** and **evolutionary algorithms** can be combined when training neural networks. In addition, it explores the use of **learnable activation functions**—bringing together ideas from **[NEAT](https://www.cs.utexas.edu/ftp/AI-Lab/tech-reports/UT-AI-TR-01-290.pdf)** and **[KAN](https://arxiv.org/abs/2404.19756)**—to study how network structure, weights, and activation functions can be jointly optimized.

The core motivation is to investigate whether this hybrid approach can achieve better expressivity than either method alone—particularly for **physics- and engineering-driven problems**, where accurate approximation of analytical functions is critical.

## Features

This is a work in progress. As of now, a full implementation of the NEAT algorithm has been completed, with the ability to further train the networks generated by the evolutionary algorithm using gradient descent. Support for learnable activation functions is not yet complete.

See the notebooks in the *examples* folder for practical examples demonstrating the current capabilities of the library.
